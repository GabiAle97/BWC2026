...
const TRANSLATIONS = {
  es: {
    ...
    diaryPage4: '<p>Septiembre 6. Noche</p><br><p>Acabo de despertar</p><p>Ese maldito hijo de perra logró infectarme. Creí que ya estaría muerta, pero Carlos me salvó.</p><p>Nuestra escapatoria fracasó, el helicoptero se hizo trizas, y ya no nos queda tiempo.</p><p>Pero tengo una última esperanza...</p><p>Una última escapatoria...</p><br><p>Si tan solo... Pudiera alcanzarme...</p><p>Sé que suena desquiciado, pero me vi a mi misma correr, esquivarlos, pelear con uñas y dientes para alcanzar a otra yo...</p><p>Quizá sea el efecto del virus, pero no puedo evitar sentir que hay otra versión de mí luchando por sobrevivir en algún lugar.</p><p>Y para alcanzarla, debo seguir luchando, sin importar el costo.</p><p>No quiero volver al principio... Y tener que vivir esto otra vez.</p><p>Pero por ahora... Debo seguir adelante.</p>'
  },
  en: {
    ...
    diaryPage4: '<p>September 6. Night</p><br><p>I just woke up.</p><p>That damn son of a bitch managed to infect me. I thought I\'d be dead already, but Carlos saved me.</p><p>Our escape failed, the helicopter was smashed to pieces, and we\'re out of time.</p><p>But I have one last hope...</p><p>My Last Escape...</p><br><p>If only... I could reach me...</p><p>I know it sounds insane, but I saw myself running, dodging them, fighting tooth and nail to reach another me...</p><p>Maybe it\'s the virus talking, but I can\'t help feeling that there\'s another version of me out there fighting to survive.</p><p>And to reach her, I have to keep fighting, no matter the cost.</p><p>I don\'t want to go back to the beginning... And have to live through this again.</p><p>But for now... I have to keep going.</p>'
  }
};
